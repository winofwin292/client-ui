...
function TrackingOrder() {
    ...
    const handleSearch = async (e) => {
        ...
        if (
            !validator.isMobilePhone(keyword, "vi-VN") &&
            !validator.isEmail(keyword)
        ) {
            showNoti("Vui lòng nhập số điện thoại hoặc email hợp lệ!", "error");
            setKeyword("");
            return;
        } else {
        ...
        const response = await orderApi.getByKeyword({
            keyword: keyword,
            type: type,
        });
    ...
    return (
        <div className="bg-white dark:bg-gray-900">
            ...
            <div className="max-w-7xl px-4 pt-2 pb-4 sm:px-6 lg:px-8 lg:pt-2 lg:pb-4 sm:min-h-80 lg:min-h-80">
                <div className="py-2 lg:pt-2 lg:pb-2 lg:ml-60">
                    <div className="max-w-2xl mx-auto">
                        <form className="flex items-center">
                            ...
                            <div className="relative w-full">
                                ...
                                <input
                                    ...
                                    placeholder="Số điện thoại hoặc email đã đặt hàng..."
                                    required
                                    value={keyword}
                        ...
                        {result ? (
                            ...
                            <p className="mt-5 dark:text-white">
                                Vui lòng nhập số điện thoại hoặc email đã đặt
                                hàng để tìm kiếm đơn hàng.
                            </p>
                        )}
                    </div>
                </div>
