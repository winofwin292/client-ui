...
function EditToolbar(props) {
    ...
    return (
        <GridToolbarContainer>
            ...
            <GridToolbarDensitySelector />
            <GridToolbarFilterButton />
            <AddPoster open={open} setOpen={setOpen} getData={getData} />
        </GridToolbarContainer>
    );
}
...
function ManagerPoster() {
    ...
    const getData = useCallback(async () => {
        const response = await posterApi.getAllAdmin();
    ...
    const handleDelete = async (data) => {
        const response = await posterApi.delete({
            id: data.id,
    ...
    const processRowUpdate = async (newRow) => {
        ...
        const response = await posterApi.edit({
            id,
            data,
...
export default memo(ManagerPoster);
