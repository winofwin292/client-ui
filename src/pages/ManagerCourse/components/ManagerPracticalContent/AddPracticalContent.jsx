...
function AddPracticalContent(props) {
    ...
    const handleSubmit = async (e) => {
        ...
        const response = await practicalContentApi.add(data);
    ...
    return (
        <div>
            ...
            >
                <DialogTitle>Thêm mới nội dung thực hành</DialogTitle>
                <DialogContent>
                    <TextField
                        autoFocus
                        margin="dense"
...
export default memo(AddPracticalContent);
